...
<html lang="pt">
  ...
  <body style="background-image:url(imagem/background-azul-escuro.jpg)">
    ...
    <div class="container">
      ...
      <!-- Page Heading -->
      <h1 class="my-4" style="color:white">Perdidos
        <small>confira</small>
      </h1>
      
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100" style="background-color: hsl(360, 100%, 75%);">
            <a href="#"><img class="card-img-top" src="imagem/caderno.jpg" alt=""></a>
            <div class="card-body">
              <h6 class="card-subtitle">perdido por </h6>
              <h5 class="card-title">
                <a href="#">Pedro Faria</a>
              </h5>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100" style="background-color: hsl(360, 100%, 75%);">
            <a href="#"><img class="card-img-top" src="imagem/garrafa.jpg" alt=""></a>
            <div class="card-body">
                <h6 class="card-subtitle">perdido por </h6>
                <h5 class="card-title">
                  <a href="#">Micael Amorim</a>
                </h5>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100" style="background-color: hsl(360, 100%, 75%);">
            <a href="#"><img class="card-img-top" src="imagem/sem-foto.png" alt=""></a>
            <div class="card-body">
                <h6 class="card-subtitle">perdido por </h6>
                <h5 class="card-title">
                  <a href="#">Fulano de tal</a>
                </h5>
              <p class="card-text">Texto explicativo feito por fulano que encontrou o objeto (...)</p>
            </div>
            <div class="card-footer">
                <a href="#" class="btn btn-primary">Postar</a>
            </div>
